            ...
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8 shadow-xl dark:shadow-gray-800 rounded-lg ">
                <div className="mt-2 overflow-hidden ">
                    <div className="grid grid-cols-1 md:grid-cols-2 py-10 ">
                        <div className="p-8 mr-2 bg-gray-100 sm:rounded-lg shadow-xl dark:shadow-gray-800  ">
                        ...
                        <form className="p-6 flex flex-col justify-center shadow-xl dark:shadow-gray-800 rounded-lg">   
                            <div className="flex flex-col shadow-xl dark:shadow-gray-800 ">
                            ...
                            <div className="flex flex-col mt-2 shadow-xl dark:shadow-gray-800">
