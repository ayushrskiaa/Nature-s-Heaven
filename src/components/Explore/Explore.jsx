...
const hotel = [
  ...
  },
  {
    ...
    name: "Forest Escape",
    place: "Imphal",
    img: "https://images.pexels.com/photos/462118/pexels-photo-462118.jpeg?auto=compress&cs=tinysrgb&w=600",
  },
  {
    id: 5,
...
function Explore() {
  ...
  const filteredHotels = hotel.filter(
    (hotelItem) =>
      hotelItem.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
      hotelItem.place.toLowerCase().includes(searchQuery.toLowerCase())
  );
  ...
  return (
    <div className="bg-gradient-to-bl from-emerald-800 to-emerald-500">
      ...
      {/* Search Bar */}
      <div className="w-1/2 mx-auto py-3 cursor-pointer">
